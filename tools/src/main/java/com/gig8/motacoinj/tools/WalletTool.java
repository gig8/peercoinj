...
package com.gig8.motacoinj.tools;

import com.gig8.motacoinj.core.*;
import com.gig8.motacoinj.core.Wallet.BalanceType;
import com.gig8.motacoinj.crypto.DeterministicKey;
import com.gig8.motacoinj.crypto.KeyCrypterException;
import com.gig8.motacoinj.crypto.MnemonicCode;
import com.gig8.motacoinj.crypto.MnemonicException;
import com.gig8.motacoinj.net.discovery.DnsDiscovery;
import com.gig8.motacoinj.params.MainNetParams;
import com.gig8.motacoinj.protocols.payments.PaymentProtocol;
import com.gig8.motacoinj.protocols.payments.PaymentProtocolException;
import com.gig8.motacoinj.protocols.payments.PaymentSession;
import com.gig8.motacoinj.store.*;
import com.gig8.motacoinj.uri.MotaCoinURI;
import com.gig8.motacoinj.uri.MotaCoinURIParseException;
import com.gig8.motacoinj.utils.BriefLogFormatter;
import com.gig8.motacoinj.wallet.DeterministicSeed;
import com.gig8.motacoinj.wallet.DeterministicUpgradeRequiredException;
import com.gig8.motacoinj.wallet.DeterministicUpgradeRequiresPassword;
...
import com.gig8.motacoinj.wallet.Protos;
...
import static com.gig8.motacoinj.core.Coin.parseCoin;
import static com.google.common.base.Preconditions.checkNotNull;

/**
 * A command line tool for manipulating wallets and working with MotaCoin.
 */
public class WalletTool {
    ...
    private static com.gig8.motacoinj.protocols.payments.Protos.PaymentRequest paymentRequest;
    ...
    public static class Condition {
        ...
        public boolean matchMotaCoins(Coin comparison) {
            try {
    ...
    private static void sendPaymentRequest(String location, boolean verifyPki) {
        if (location.startsWith("http") || location.startsWith("motacoin")) {
            try {
                ListenableFuture<PaymentSession> future;
                if (location.startsWith("http")) {
                    future = PaymentSession.createFromUrl(location, verifyPki);
                } else {
                    MotaCoinURI paymentRequestURI = new MotaCoinURI(location);
                    future = PaymentSession.createFromMotaCoinUri(paymentRequestURI, verifyPki);
                }
                ...
                System.err.println("Invalid motacoin uri: " + e.getMessage());
                System.exit(1);
            } catch (InterruptedException e) {
                // Ignore.
            } catch (ExecutionException e) {
            ...
            try {
                paymentRequest = com.gig8.motacoinj.protocols.payments.Protos.PaymentRequest.newBuilder().mergeFrom(stream).build();
            } catch(IOException e) {
    ...
    private static void wait(WaitForEnum waitFor) throws BlockStoreException, IOException {
        ...
        switch (waitFor) {
            ...
            case BALANCE:
                ...
                if (condition.matchMotaCoins(wallet.getBalance(Wallet.BalanceType.ESTIMATED))) {
                    latch.countDown();
                    break;
                }
                wallet.addEventListener(new AbstractWalletEventListener() {
                    ...
                    public synchronized void onChange() {
                        ...
                        if (condition.matchMotaCoins(balance)) {
    ...
    private static void deleteKey() {
        ...
        if (pubkey != null) {
            ...
            try {
                ...
                System.err.println(addr + " does not parse as a MotaCoin address of the right network parameters.");
                return;
            }
        }
        if (key == null) {
