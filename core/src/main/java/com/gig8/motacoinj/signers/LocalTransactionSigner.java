 ...
 */
package com.gig8.motacoinj.signers;

import com.gig8.motacoinj.core.ECKey;
import com.gig8.motacoinj.core.ScriptException;
import com.gig8.motacoinj.core.Transaction;
import com.gig8.motacoinj.core.TransactionInput;
...
import com.gig8.motacoinj.wallet.KeyBag;
import com.gig8.motacoinj.wallet.RedeemData;
import org.slf4j.Logger;
import org.slf4j.LoggerFactory;

/**
 * <p>{@link TransactionSigner} implementation for signing inputs using keys from provided {@link com.gig8.motacoinj.wallet.KeyBag}.</p>
 ...
 * <p>This signer always uses {@link com.gig8.motacoinj.core.Transaction.SigHash#ALL} signing mode.</p>
 */
    ...
    public boolean signInputs(ProposedTransaction propTx, KeyBag keyBag) {
        ...
        for (int i = 0; i < numInputs; i++) {
            ...
            try {
                ...
                int sigIndex = 0;
                inputScript = scriptPubKey.getScriptSigWithSignature(inputScript, signature.encodeToMotaCoin(), sigIndex);
