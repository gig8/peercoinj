...
import com.gig8.motacoinj.core.StoredBlock;
 ...
 *
 * A BlockStore is a map of hashes to StoredBlock. The hash is the double digest of the MotaCoin serialization
...
public interface BlockStore {
     ...
     * can be arbitrarily expensive, you probably should use {@link com.gig8.motacoinj.core.BlockChain#getChainHead()}
     * or perhaps {@link com.gig8.motacoinj.core.BlockChain#getBestChainHeight()} which will run in constant time and
