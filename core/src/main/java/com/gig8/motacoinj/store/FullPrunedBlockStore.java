...
import com.gig8.motacoinj.core.StoredTransactionOutput;
import com.gig8.motacoinj.core.StoredUndoableBlock;
 ...
 * MotaCoin serialization of the block header, <b>not</b> the header with the extra data as well.</p>
 * 
 * <p>A FullPrunedBlockStore also contains a map of hash+index to StoredTransactionOutput.  Again, the hash is
 * a standard MotaCoin double-SHA256 hash of the transaction.</p>
 *
