...
public class VersionMessage extends Message {
    ...
    public static final String LIBRARY_SUBVER = "/MotaCoinJ:" + PEERCOINJ_VERSION + "/";
    ...
    @Override
    public void motacoinSerializeToStream(OutputStream buf) throws IOException {
        ...
        try {
            // My address.
            myAddr.motacoinSerialize(buf);
            // Their address.
            theirAddr.motacoinSerialize(buf);
        } catch (UnknownHostException e) {
     ...
     * name:version pairs separated by slashes in the form of a path. For example a typical subVer field for MotaCoinJ
     * users might look like "/MotaCoinJ:0.4-SNAPSHOT/MultiBit:1.2/" where libraries come further to the left.<p>
     *
     ...
     * set of "/MotaCoinJ:1.0/MultiBit:1.0(Windows)/. Therefore the / ( and ) characters are reserved in all these
     * components. If you don't want to add a comment (recommended), pass null.<p>
     *
     * See <a href="https://github.com.gig8/bips/blob/master/bip-0014.mediawiki">BIP 14</a> for more information.
     *
