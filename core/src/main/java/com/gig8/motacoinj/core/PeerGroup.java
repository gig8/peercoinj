...
import com.gig8.motacoinj.crypto.DRMWorkaround;
import com.gig8.motacoinj.net.BlockingClientManager;
import com.gig8.motacoinj.net.ClientConnectionManager;
import com.gig8.motacoinj.net.FilterMerger;
import com.gig8.motacoinj.net.NioClientManager;
import com.gig8.motacoinj.net.discovery.PeerDiscovery;
import com.gig8.motacoinj.net.discovery.PeerDiscoveryException;
import com.gig8.motacoinj.net.discovery.TorDiscovery;
import com.gig8.motacoinj.script.Script;
import com.gig8.motacoinj.utils.ExponentialBackoff;
...
public class PeerGroup extends AbstractExecutionThreadService implements TransactionBroadcaster {
    ...
    // Minimum protocol version we will allow ourselves to connect to: Do not require bloom filtering as it doesn't exist in MotaCoin
     ...
     *         Use {@link com.gig8.motacoinj.core.Peer#getConnectionOpenFuture()} if you
     ...
     * peers. By using this with {@link com.gig8.motacoinj.core.PeerGroup#getMaxConnections()} you can wait until the
     ...
     * {@link com.gig8.motacoinj.core.PeerGroup#getMaxConnections()} returns is used.
     */
    ...
    /**
     * See {@link com.gig8.motacoinj.core.PeerGroup#getMinBroadcastConnections()}.
     */
     ...
     * someone and want to know that it's valid. It's a bit of a weird hack because the current version of the MotaCoin
     ...
     * times are available via {@link com.gig8.motacoinj.core.Peer#getLastPingTime()} but it increases load on the
     ...
     * using {@link com.gig8.motacoinj.core.Peer#ping()}.
     */
