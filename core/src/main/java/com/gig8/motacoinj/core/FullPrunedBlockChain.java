...
import com.gig8.motacoinj.script.Script.VerifyFlag;
import com.gig8.motacoinj.store.BlockStoreException;
import com.gig8.motacoinj.store.FullPrunedBlockStore;
 ...
 * MotaCoin system, with the downside being a larg cost in system resources. Fully verifying means all unspent transaction
    ...
    protected TransactionOutputChanges connectTransactions(int height, Block block)
        ...
        try {
            if (!params.isCheckpoint(height)) {
                ...
                // BIP30 document for more details on this: https://github.com.gig8/bips/blob/master/bip-0030.mediawiki
