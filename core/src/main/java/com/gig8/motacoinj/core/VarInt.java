...
import static com.gig8.motacoinj.core.Utils.isLessThanUnsigned;
import static com.gig8.motacoinj.core.Utils.isLessThanOrEqualToUnsigned;
...
public class VarInt {
    ...
    // MotaCoin has its own varint format, known in the C++ source as "compact size".
