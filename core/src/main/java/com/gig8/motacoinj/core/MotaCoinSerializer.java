...
/**
 * <p>Methods to serialize and de-serialize messages to the MotaCoin network format as defined in
 * <a href="https://en.motacoin.it/wiki/Protocol_specification">the protocol specification</a>.</p>
 *
 ...
 * <li>Message.motacoinSerializeToStream() needs to be properly subclassed</li>
 * </ul>
 */
public class MotaCoinSerializer {
    private static final Logger log = LoggerFactory.getLogger(MotaCoinSerializer.class);
    ...
    /**
     * Constructs a MotaCoinSerializer with the given behavior.
     *
     * @param params           networkParams used to create Messages instances and termining packetMagic
     */
    public MotaCoinSerializer(NetworkParameters params) {
     ...
     */
    public MotaCoinSerializer(NetworkParameters params, boolean parseLazy, boolean parseRetain) {
        this.params = params;
    ...
    public void serialize(Message message, OutputStream out) throws IOException {
        ...
        if (name == null) {
            throw new Error("MotaCoinSerializer doesn't currently know how to serialize " + message.getClass());
        }
        serialize(name, message.motacoinSerialize(), out);
    }
    ...
    public Message deserialize(ByteBuffer in) throws ProtocolException, IOException {
        // A MotaCoin protocol message has the following format.
        //
        ...
        MotaCoinPacketHeader header = new MotaCoinPacketHeader(in);
     ...
     */
    public MotaCoinPacketHeader deserializeHeader(ByteBuffer in) throws ProtocolException, IOException {
        return new MotaCoinPacketHeader(in);
    }

    /**
     * Deserialize payload only.  You must provide a header, typically obtained by calling
     * {@link MotaCoinSerializer#deserializeHeader}.
     */
    public Message deserializePayload(MotaCoinPacketHeader header, ByteBuffer in) throws ProtocolException, BufferUnderflowException {
    ...
    public static class MotaCoinPacketHeader {
        ...
        public MotaCoinPacketHeader(ByteBuffer in) throws ProtocolException, BufferUnderflowException {
