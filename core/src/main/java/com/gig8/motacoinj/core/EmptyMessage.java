 ...
 * Currently this includes getaddr, ping, verack as well as the special motacoinj class UnknownMessage
 *
 * @author git
 */
public abstract class EmptyMessage extends Message {
    ...
    @Override
    final protected void motacoinSerializeToStream(OutputStream stream) throws IOException {
    }
