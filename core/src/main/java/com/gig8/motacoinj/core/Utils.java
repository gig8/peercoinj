...
/**
 * A collection of various utility methods that are helpful for working with the MotaCoin protocol.
 * To enable debug logging from the library, run with -Dmotacoinj.logging=true on your command line.
 */
public class Utils {
    ...
    /** The string that prefixes all text messages signed using MotaCoin keys. */
    public static final String MotaCoin_SIGNED_MESSAGE_HEADER = "MotaCoin Signed Message:\n";
    public static final byte[] MotaCoin_SIGNED_MESSAGE_HEADER_BYTES = MotaCoin_SIGNED_MESSAGE_HEADER.getBytes(Charsets.UTF_8);
     ...
     * standard procedure in MotaCoin. The resulting hash is in big endian form.
     */
     ...
     *
     * <p>MotaCoin only uses this "compact" format for encoding difficulty targets, which are unsigned 256bit quantities.
     ...
     *
     * <tt><p>[24] "MotaCoin Signed Message:\n" [message.length as a varint] message</p></tt>
     */
    public static byte[] formatMessageForSigning(String message) {
        try {
            ByteArrayOutputStream bos = new ByteArrayOutputStream();
            bos.write(MotaCoin_SIGNED_MESSAGE_HEADER_BYTES.length);
            bos.write(MotaCoin_SIGNED_MESSAGE_HEADER_BYTES);
