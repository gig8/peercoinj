...
import com.gig8.motacoinj.wallet.KeyChainEventListener;
...
public interface WalletEventListener extends KeyChainEventListener {
     ...
     * the object retrieved via {@link com.gig8.motacoinj.core.Transaction#getConfidence()}. It's safe to modify the
