...
import com.gig8.motacoinj.utils.MonetaryFormat;
...
public final class Coin implements Monetary, Comparable<Coin>, Serializable {
    ...
    /**
     * Number of decimals for one MotaCoin. This constant is useful for quick adapting to other coins because a lot of
     * constants derive from it.
     */
    public static final int SMALLEST_UNIT_EXPONENT = 6;

    /**
     * The number of satoshis equal to one motacoin.
     */
    ...
    /**
     * 0.01 MotaCoins. This unit is not really used much.
     */
    public static final Coin CENT = COIN.divide(100);

    /**
     * 0.001 MotaCoins, also known as 1 mMOTA.
     */
    public static final Coin MILLICOIN = COIN.divide(1000);

    /**
     * 0.000001 MotaCoin, also known as 1 µMOTA or 1 uMOTA.
     */
    public static final Coin MICROCOIN = MILLICOIN.divide(1000);

    /**
     * A satoshi is the smallest unit that can be transferred. 1 million of them fit into a MotaCoin.
     */
    ...
    private Coin(final long satoshis) {
        checkArgument(-MAX_SATOSHIS <= satoshis && satoshis <= MAX_SATOSHIS,
            "%s satoshis exceeds maximum possible quantity of MotaCoin.", satoshis);
        this.value = satoshis;
    }
    ...
    private static final MonetaryFormat FRIENDLY_FORMAT = MonetaryFormat.MOTA.minDecimals(2).repeatOptionalDecimals(1, 4).postfixCode();
    ...
    private static final MonetaryFormat PLAIN_FORMAT = MonetaryFormat.MOTA.minDecimals(0).repeatOptionalDecimals(1, 6).noCode();

    /**
     * <p>
     * Returns the value as a plain string denominated in MOTA.
     * The result is unformatted with no trailing zeroes.
     * For instance, a value of 150000 satoshis gives an output string of "0.0015" MOTA
     * </p>
     */
