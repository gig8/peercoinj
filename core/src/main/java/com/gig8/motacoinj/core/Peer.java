...
import com.gig8.motacoinj.net.AbstractTimeoutHandler;
import com.gig8.motacoinj.store.BlockStore;
...
/**
 * <p>A Peer handles the high level communication with a MotaCoin node, extending a {@link PeerSocketHandler} which
 * handles low-level message (de)serialization.</p>
 *
 * <p>Note that timeouts are handled by the extended
 * {@link com.gig8.motacoinj.net.AbstractTimeoutHandler} and timeout is automatically disabled (using
 * {@link com.gig8.motacoinj.net.AbstractTimeoutHandler#setTimeoutEnabled(boolean)}) once the version
...
public class Peer extends PeerSocketHandler {
    ...
    private static class GetDataRequest {
        ...
        // a nasty hack that relies on the fact that motacoin-qt is single threaded and processes messages in order.
     ...
     * {@link com.gig8.motacoinj.net.NioClientManager#openConnection(java.net.SocketAddress, com.gig8.motacoinj.net.StreamParser)}
     * or
     * {@link com.gig8.motacoinj.net.NioClient#NioClient(java.net.SocketAddress, com.gig8.motacoinj.net.StreamParser, int)}.</p>
     *
    ...
    private void processVersionMessage(VersionMessage m) throws ProtocolException {
        ...
        // motacoinj is a client mode implementation. That means there's not much point in us talking to other client
    ...
    public void setDownloadParameters(long secondsSinceEpoch, boolean useFilteredBlocks) {
    	// For motacoin we cannot use filtered blocks until the protocol has been upgraded
        lock.lock();
        try {
     ...
     * Once the pong is received the value returned by {@link com.gig8.motacoinj.core.Peer#getLastPingTime()} is
     * updated.
    ...
    /**
     * Returns the elapsed time of the last ping/pong cycle. If {@link com.gig8.motacoinj.core.Peer#ping()} has never
    ...
    /**
     * Returns a moving average of the last N ping/pong cycles. If {@link com.gig8.motacoinj.core.Peer#ping()} has never
