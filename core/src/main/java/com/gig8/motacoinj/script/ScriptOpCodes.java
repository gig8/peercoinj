...
/**
 * Various constants that define the assembly-like scripting language that forms part of the MotaCoin protocol.
 * See {@link com.gig8.motacoinj.script.Script} for details. Also provides a method to convert them to a string.
 */
