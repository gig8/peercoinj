...
package com.gig8.motacoinj.script;
...
import static com.gig8.motacoinj.script.ScriptOpCodes.*;
import static com.google.common.base.Preconditions.*;

/**
 * <p>Programs embedded inside transactions that control redemption of payments.</p>
 *
 * <p>MotaCoin transactions don't specify what they do directly. Instead <a href="https://en.motacoin.it/wiki/Script">a
...
public class Script {
     ...
     * The concept of a "from address" isn't well defined in MotaCoin and you should not assume the sender of a
    ...
    private int findSigInRedeem(byte[] signatureBytes, Sha256Hash hash) {
        checkArgument(chunks.get(0).isOpCode()); // P2SH scriptSig
        int numKeys = Script.decodeFromOpN(chunks.get(chunks.size() - 2).opcode);
        TransactionSignature signature = TransactionSignature.decodeFromMotaCoin(signatureBytes, true);
        for (int i = 0 ; i < numKeys ; i++) {
     ...
     * logic is defined by <a href="https://github.com/motacoin/bips/blob/master/bip-0016.mediawiki">BIP 16</a>.</p>
     *
     * <p>motacoinj does not support creation of P2SH transactions today. The goal of P2SH is to allow short addresses
     ...
     * {@link com.gig8.motacoinj.core.TransactionInput#verify(com.gig8.motacoinj.core.TransactionOutput)} or
     * {@link com.gig8.motacoinj.script.Script#correctlySpends(com.gig8.motacoinj.core.Transaction, long, Script)}. This method
    ...
    private static void executeCheckSig(Transaction txContainingThis, int index, Script script, LinkedList<byte[]> stack,
        ...
        try {
            TransactionSignature sig  = TransactionSignature.decodeFromMotaCoin(sigBytes, false);
    ...
    private static int executeMultiSig(Transaction txContainingThis, int index, Script script, LinkedList<byte[]> stack,
        ...
        while (sigs.size() > 0) {
            ...
            try {
                TransactionSignature sig = TransactionSignature.decodeFromMotaCoin(sigs.getFirst(), false);
                Sha256Hash hash = txContainingThis.hashForSignature(index, connectedScript, (byte) sig.sighashFlags);
    ...
    public void correctlySpends(Transaction txContainingThis, long scriptSigIndex, Script scriptPubKey,
        ...
        try {
            txContainingThis = new Transaction(txContainingThis.getParams(), txContainingThis.motacoinSerialize());
