 ...
 *
 * <p>When formatting MotaCoin monetary values, an instance of this class automatically adjusts
 ...
 *
 * <p>When parsing <code>String</code> representations of MotaCoin monetary values, instances of
...
public final class PpcAutoFormat extends PpcFormat {
    ...
    public enum Style {
        ...
        /** Constant for the formatting style that uses a currency code, e.g., "MOTA". */
        CODE {
    ...
    /**
     * Calculate the appropriate denomination for the given MotaCoin monetary value.  This
