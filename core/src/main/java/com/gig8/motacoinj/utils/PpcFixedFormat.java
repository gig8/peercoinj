...
import static com.gig8.motacoinj.core.Coin.SMALLEST_UNIT_EXPONENT;
 ...
 * instance formats and by-default parses all MotaCoin monetary values in units of a single
...
public final class PpcFixedFormat extends PpcFormat {
     ...
     *  thet same value expressed in motacoins. */
     ...
     * the denomination is millimotacoins, this method will return the value <code>3</code>.  As
     ...
     *  the denomination is millimotacoins, this method will return the value <code>3</code>.  */
    @Override
     ...
     * denomination is millimotacoins, then this method will return <code>"mMOTA"</code>,
     ...
     * millimotacoins, this method by default returns <code>"₥Ꝑ"</code>, depending on the
     * locale.  */
