...
import com.gig8.motacoinj.utils.PpcAutoFormat.Style;
import static com.gig8.motacoinj.utils.PpcAutoFormat.Style.*;
 ...
 * representations of MotaCoin monetary values.
 *
 ...
 * represents a MotaCoin monetary value.  Some of the features offered for doing this
 * are: <ol>
 ...
 * String c = f.format(Coin.COIN);                <strong>// "MOTA 1.00"</strong>
 * String k = f.format(Coin.COIN.multiply(1000)); <strong>// "MOTA 1,000.00"</strong>
 * String m = f.format(Coin.COIN.divide(1000));   <strong>// "mMOTA 1.00"</strong>
 ...
 * code, such as <code>"MOTA"</code>, to indicate the units of denomination, while the
 * <code>SYMBOL</code> style uses a possibly-ambiguous currency symbol such as
 * <code>"Ꝑ"</code>.
 *
 * <p>The denomination used when formatting will be either motacoin, millicoin
 ...
 * locale, a value of one motacoin might be formatted as <pre>Ꝑ1.00</pre> where a value
 ...
 * increasing precision to convert the representation of a given quantity of motacoins into a
 * representation of the same value denominated in the formatter's units.  For example, a scale
 * value of <code>3</code> specifies a denomination of millimotacoins, because to represent
 * <code>1.0000 MOTA</code>, or one motacoin, in millimotacoins, one shifts the decimal point
 * three places, that is, to <code>1000.0 mMOTA</code>.
 *
 * <h3>Construction</h3>
 *
 ...
 * <blockquote><pre>
 * PpcFormat f = PpcFormat.getInstance();
 * String s = f.format(Coin.COIN); <strong>// "MOTA 1.00"</strong>
 * </pre></blockquote>
 *
 ...
 * values in units of micromotacoins:
 *
 ...
 * differently the same one-motacoin value:
 *
 * <blockquote><pre>
 * <strong>// Next line returns "1,00 MOTA"</strong>
 ...
 *
 * <blockquote><pre>
 * PpcFormat f = PpcFormat.builder().style(CODE).code("MOTA").build();
 * String out = f.format(COIN); <strong>// "MOTA 1.00"</strong>
 * </pre></blockquote>
 *
 ...
 * <h3>Formatting</h3>
 *
 * <p>You format a MotaCoin monetary value by passing it to the {@link PpcFormat#format(Object)}
 * method.  This argument can be either a {@link com.gig8.motacoinj.core.Coin}-type object or a
 ...
 * number of motacoins.  A value having a fractional amount of satoshis is rounded to the
 ...
 * <strong>// next line formats the value as "987.654.321,23 µMOTA"</strong>
 * String output = de.format(valueOf(98765432123L), new StringBuffer(), currField);
 * <strong>// next line sets variable currencyCode to "µMOTA"</strong>
 ...
 * <strong>// variable coded will be set to "kMOTA 1.23"</strong>
 ...
 * <code>µMOTA</code> or other appropriate permutations of those characters.  Additionally, if
 ...
 * instance will infer a denomination of motacoins while a {@link PpcFixedFormat} will infer the
 ...
 * @see          com.gig8.motacoinj.core.Coin
 */
...
public abstract class PpcFormat extends Format {
    ...
    /** The conventional international currency code for motacoins: "MOTA" */
    private static final String COIN_CODE = "MOTA";
    /** The default currency symbols for motacoins */
    ...
    /* Scale is the number of decimal-places difference from same value in motacoins */
    /** A constant useful for specifying a denomination of motacoins, the <code>int</code> value
     *  <code>0</code>. */
    public static final int COIN_SCALE = 0;

    /** A constant useful for specifying a denomination of millimotacoins, the <code>int</code>
     *  value <code>3</code>. */
    public static final int MILLICOIN_SCALE = 3;

    /** A constant useful for specifying a denomination of micromotacoins, the <code>int</code>
     *  value <code>6</code>. */
    ...
    public static class Builder {
         ...
         *  denominated in motacoins.  For example, a denomination of millimotacoins is specified
         ...
         * fixed-denomination of motacoins, equivalent to invoking this method with an argument
         * of <code>0</code>. */
     ...
     * currency code, for example "<code>MOTA</code>", to indicate that denomination.  The
    ...
    /**
     * Return a new auto-denominating instance that will indicate units using a currency
     * code, for example, <code>"MOTA"</code>.  Formatting and parsing will be done
     * according to the default locale.
     */
     ...
     * <code>"MOTA"</code>.  The returned object will format the fraction-part of numbers using
     * the given number of decimal places, or fewer as necessary to avoid giving a place to
     * fractional satoshis.  Formatting and parsing will be done according to the default
     * locale.
     */
     ...
     * units using a currency code, for example, <code>"mMOTA"</code>.
     */
     ...
     * <code>"mMOTA"</code>.  The returned object will format the fraction-part of numbers using
     * the given number of decimal places, or fewer as necessary to avoid giving a place to
     * fractional satoshis.
     */
     ...
     * <code>"Ꝑ"</code>, or code, such as <code>"mMOTA"</code>, depending on the value of
     ...
     * <code>"mMOTA"</code>, depending on the value of the first argument.  The returned object
     ...
     * "<code>MOTA</code>", or symbol, such as "<code>Ꝑ</code>", depending on the value
     ...
     * such as <code>"mMOTA"</code>, or symbol, such as "<code>Ꝑ</code>",
     ...
     * values in terms of motacoins, with the given minimum number of fractional
    ...
    /**
     * Formats a motacoin monetary value and returns an {@link java.text.AttributedCharacterIterator}.
    ...
    /**
     * Formats a motacoin value as a number and possibly a units indicator and appends the
     ...
     * number of motacoins, rounded to the nearest satoshi as necessary.
     *
    ...
    /**
     * Formats a motacoin value as a number and possibly a units indicator to a
     ...
     * <code>BigDecimal</code> is interpreted as that number of motacoins, rounded to the
     ...
     * is the size of the decimal-place shift between the given MotaCoin-value denominated in
     * motacoins and that same value as formatted.  A fixed-denomination formatter will ignore
     * the arguments.
     *
    ...
    /**
     * Takes a motacoin monetary value that the client wants to format and returns the number of
    ...
    /**
     * Takes an object representing a motacoin quantity of any type the
	...
	BigInteger satoshis;
        // the value might be motacoins or satoshis
    ...
    /**
      * Parse a <code>String</code> representation of a MotaCoin monetary value.  Returns a
      * {@link com.gig8.motacoinj.core.Coin} object that represents the parsed value.
      * @see java.text.NumberFormat */
    @Override
    ...
    private volatile String ci = "(" + COIN_SYMBOL + "|" + COIN_SYMBOL_ALT + "|Ꝑ|" + COIN_CODE + "|MOTA)";
    ...
    /** Parse a <code>String</code> representation of a MotaCoin monetary value.  If this
     ...
     * String, then the number is interpreted as a quatity of motacoins.
     * <p>If the pattern contains neither a currency symbol nor sign, then instances of {@link
     * PpcAutoFormat} will interpret the parsed number as a quantity of motacoins, and instances
    ...
    /** Return the unprefixed currency symbol for motacoins configured for this object.  The
    ...
    /** Return the unprefixed international currency code for motacoins configured for this
