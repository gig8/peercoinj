...
import com.gig8.motacoinj.shapeshift.ShapeShiftMonetary;
...
public final class MonetaryFormat {
    ...
    /** Standard format for the MOTA denomination. */
    public static final MonetaryFormat MOTA = new MonetaryFormat().shift(0).minDecimals(2).repeatOptionalDecimals(2, 2);
    /** Standard format for the mMOTA denomination. */
    public static final MonetaryFormat MMOTA = new MonetaryFormat().shift(3).minDecimals(2).optionalDecimals(1);
    /** Standard format for the µMOTA denomination. */
    public static final MonetaryFormat UMOTA = new MonetaryFormat().shift(6).minDecimals(0).optionalDecimals(0);
    /** Standard format for fiat amounts. */
    public static final MonetaryFormat FIAT = new MonetaryFormat().shift(0).minDecimals(2).repeatOptionalDecimals(2, 1);
    /** Currency code for base 1 MotaCoin. */
    public static final String CODE_MOTA = "MOTA";
    /** Currency code for base 1/1000 MotaCoin. */
    public static final String CODE_MMOTA = "mMOTA";
    /** Currency code for base 1/1000000 MotaCoin. */
    public static final String CODE_UMOTA = "µMOTA";
    ...
    private static final String DECIMALS_PADDING = "0000000000000000"; // a few more than necessary for MotaCoin
    ...
    /**
     * Set number of digits to shift the decimal separator to the right, coming from the standard MOTA notation that was
    ...
    public MonetaryFormat() {
        ...
        this.codes.put(0, CODE_MOTA);
        this.codes.put(3, CODE_MMOTA);
        this.codes.put(6, CODE_UMOTA);
        this.codeSeparator = ' ';
    ...
    /**
     * Parse a human readable coin value to a {@link com.gig8.motacoinj.core.Coin} instance.
     * 
    ...
    /**
     * Parse a human readable fiat value to a {@link com.gig8.motacoinj.core.Fiat} instance.
     * 
     * @throws NumberFormatException
     *             if the string cannot be parsed for some reason
     */
    ...
    /**
     * Gets a {@link com.gig8.motacoinj.shapeshift.ShapeShiftMonetary} for a string formatted with the MonetaryFormat
     *
