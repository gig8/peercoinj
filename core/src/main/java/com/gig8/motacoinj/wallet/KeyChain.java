...
/**
 * <p>A KeyChain is a class that stores a collection of keys for a {@link com.gig8.motacoinj.core.Wallet}. Key chains
...
public interface KeyChain {
    ...
    /** Returns a list of keys serialized to the motacoinj protobuf format. */
     ...
     *
     * <p>See the docs for {@link com.gig8.motacoinj.core.BloomFilter#BloomFilter(int, double, long)} for a brief
