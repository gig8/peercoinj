...
public class DeterministicSeed implements EncryptableItem {
    ...
    /**
     * Constructs a seed from a BIP 39 mnemonic code. See {@link com.gig8.motacoinj.crypto.MnemonicCode} for more
     ...
     *
     * @throws com.gig8.motacoinj.crypto.MnemonicException if check fails
     */
