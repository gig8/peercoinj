...
public class BasicKeyChain implements EncryptableKeyChain {
     ...
     * @throws com.gig8.motacoinj.store.UnreadableWalletException.BadPassword if the password doesn't seem to match
     * @throws com.gig8.motacoinj.store.UnreadableWalletException if the data structures are corrupted/inconsistent
     */
    ...
    /**
     * Convenience wrapper around {@link #toEncrypted(com.gig8.motacoinj.crypto.KeyCrypter,
    ...
    public BasicKeyChain toEncrypted(KeyCrypter keyCrypter, KeyParameter aesKey) {
        ...
        try {
            ...
            for (ECKey key : hashToKeys.values()) {
                ...
                // (all motacoin controlled by that private key is lost forever).
