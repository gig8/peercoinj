...
import com.gig8.motacoinj.crypto.ChildNumber;
import com.gig8.motacoinj.crypto.DeterministicKey;
import com.gig8.motacoinj.crypto.KeyCrypter;
...
/**
 * <p>A KeyChainGroup is used by the {@link com.gig8.motacoinj.core.Wallet} and
...
public class KeyChainGroup implements KeyBag {
     ...
     * <p>IMPORTANT: As of MotaCoin Core 0.9 all multisig transactions which require more than 3 public keys are non-standard
     ...
     *
     * @throws com.gig8.motacoinj.crypto.KeyCrypterException Thrown if the wallet encryption fails for some reason,
     ...
     * KeyCrypter to use is {@link com.gig8.motacoinj.crypto.KeyCrypterScrypt}.
     *
     * @throws com.gig8.motacoinj.crypto.KeyCrypterException Thrown if the wallet decryption fails for some reason, leaving the group unchanged.
     */
