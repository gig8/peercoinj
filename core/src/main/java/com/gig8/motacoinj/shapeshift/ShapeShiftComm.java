...
/**
 * Implements {@link com.gig8.motacoinj.shapeshift.ShapeShiftInterface}
 *
...
public class ShapeShiftComm extends ShapeShiftInterface {
	...
	public void sendAmount(final ShapeShiftCoin destCoin, Address destAddr, ShapeShiftMonetary amount, Address refund) {
		...
		try {
			jsonRequest.put("pair", "mota_" + destCoin.coinCode);
	...
	public void limit(ShapeShiftCoin destCoin) {
		client.get(API_URL + "limit/mota_" + destCoin.coinCode, new ResponseCallback() {
	...
	public void rate(ShapeShiftCoin destCoin) {
		client.get(API_URL + "rate/" + destCoin.coinCode + "_mota", new ResponseCallback() {
	...
	public void marketInfo(final ShapeShiftCoin destCoin) {
		client.get(API_URL + "marketinfo/mota_" + destCoin.coinCode, new ResponseCallback() {
