...
import com.gig8.motacoinj.net.NioClient;
import com.gig8.motacoinj.net.ProtobufParser;
...
public class PaymentChannelClientConnection {
     ...
     * connection is open. The server is requested to keep the channel open for {@link com.gig8.motacoinj.protocols.channels.PaymentChannelClient#DEFAULT_TIME_WINDOW}
