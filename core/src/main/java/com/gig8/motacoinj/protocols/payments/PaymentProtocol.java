...
import com.gig8.motacoinj.crypto.X509Utils;
...
/**
 * <p>Utility methods and constants for working with <a href="https://github.com/motacoin/bips/blob/master/bip-0070.mediawiki">
 ...
 * protocol data does not flow over the MotaCoin P2P network or enter the block chain. It's instead for data that is only
 * of interest to the parties involved but isn't otherwise needed for consensus.</p>
 */
public class PaymentProtocol {

    // MIME types as defined in BIP71.
    public static final String MIMETYPE_PAYMENTREQUEST = "application/motacoin-paymentrequest";
    public static final String MIMETYPE_PAYMENT = "application/motacoin-payment";
    public static final String MIMETYPE_PAYMENTACK = "application/motacoin-paymentack";
    ...
    public static Protos.Payment createPaymentMessage(List<Transaction> transactions,
        ...
        for (Transaction transaction : transactions) {
            transaction.verify();
            builder.addTransactions(ByteString.copyFrom(transaction.unsafeMotaCoinSerialize()));
        }
