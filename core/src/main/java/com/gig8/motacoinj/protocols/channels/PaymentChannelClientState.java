...
import com.gig8.motacoinj.wallet.AllowUnconfirmedCoinSelector;
...
public class PaymentChannelClientState {
     ...
     * overriding {@link PaymentChannelClientState#editContractSendRequest(com.gig8.motacoinj.core.Wallet.SendRequest)}.
    ...
    public synchronized void provideRefundSignature(byte[] theirSignature) throws VerificationException {
        ...
        TransactionSignature theirSig = TransactionSignature.decodeFromMotaCoin(theirSignature, true);
