...
package com.gig8.motacoinj.protocols.payments;

import com.gig8.motacoinj.core.*;
import com.gig8.motacoinj.crypto.TrustStoreLoader;
import com.gig8.motacoinj.params.MainNetParams;
import com.gig8.motacoinj.protocols.payments.PaymentProtocol.PkiVerificationData;
...
import com.gig8.motacoinj.protocols.payments.Protos;
 ...
 *
 * <ul>
 * <li>A {@link MotaCoinURI} object that conforms to BIP 0072</li>
 * <li>A url where the {@link Protos.PaymentRequest} can be fetched</li>
 * <li>Directly with a {@link Protos.PaymentRequest} object</li>
 * </ul>
 *
 * <p>If initialized with a MotaCoinURI or a url, a network request is made for the payment request object and a
 ...
 * transactions to the motacoin network. Instead it returns a ListenableFuture that will be notified when a
 ...
 *
 * @see <a href="https://github.com/motacoin/bips/blob/master/bip-0070.mediawiki">BIP 0070</a>
 */
public class PaymentSession {
     ...
     * uri is a BIP-72-style MotaCoinURI object that specifies where the {@link Protos.PaymentRequest} object may
     ...
     * be verified.</p>
     */
    public static ListenableFuture<PaymentSession> createFromMotaCoinUri(final MotaCoinURI uri) throws PaymentProtocolException {
        return createFromMotaCoinUri(uri, true, null);
    }
     ...
     */
    public static ListenableFuture<PaymentSession> createFromMotaCoinUri(final MotaCoinURI uri, final boolean verifyPki)
            throws PaymentProtocolException {
        return createFromMotaCoinUri(uri, verifyPki, null);
    }
     ...
     */
    public static ListenableFuture<PaymentSession> createFromMotaCoinUri(final MotaCoinURI uri, final boolean verifyPki, @Nullable final TrustStoreLoader trustStoreLoader)
            throws PaymentProtocolException {
        String url = uri.getPaymentRequestUrl();
        if (url == null)
            throw new PaymentProtocolException.InvalidPaymentRequestURL("No payment request URL (r= parameter) in MotaCoinURI " + uri);
        try {
    ...
    /**
     * Returns the total amount of motacoins requested.
     */
     ...
     * NOTE: This does not broadcast the transactions to the motacoin network, it merely sends a Payment message to the
