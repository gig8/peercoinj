...
package com.gig8.motacoinj.kits;

import com.gig8.motacoinj.core.*;
import com.gig8.motacoinj.net.discovery.DnsDiscovery;
import com.gig8.motacoinj.protocols.channels.StoredPaymentChannelClientStates;
import com.gig8.motacoinj.protocols.channels.StoredPaymentChannelServerStates;
import com.gig8.motacoinj.store.BlockStoreException;
import com.gig8.motacoinj.store.SPVBlockStore;
import com.gig8.motacoinj.store.ValidHashStore;
import com.gig8.motacoinj.store.WalletProtobufSerializer;
import com.gig8.motacoinj.wallet.DeterministicSeed;
import com.gig8.motacoinj.wallet.KeyChainGroup;
...
/**
 * <p>Utility class that wraps the boilerplate needed to set up a new SPV motacoinj app. Instantiate it with a directory
 ...
 * It is to make it easier to fit motacoinj into GUI apps, which require a high degree of responsiveness on their main
 * thread which handles all the animation and user interaction. Even when blockingStart is false, initializing motacoinj
...
public class WalletAppKit extends AbstractIdleService {
     ...
     * block sync faster for new users - please refer to the documentation on the motacoinj website for further details.
     */
