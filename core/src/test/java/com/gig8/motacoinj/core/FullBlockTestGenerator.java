...
import com.gig8.motacoinj.core.Transaction.SigHash;
...
public class FullBlockTestGenerator {
    // Used by MotaCoindComparisonTool and AbstractFullPrunedBlockChainTest to create test cases
    ...
    public RuleList getBlocksToTest(boolean addSigExpensiveBlocks, boolean runLargeReorgs, File blockStorageFile) throws ScriptException, ProtocolException, IOException {
            ...
            public boolean add(Rule element) {
                if (outStream != null && element instanceof BlockAndValidity) {
                    try {
                        ...
                        byte[] block = ((BlockAndValidity)element).block.motacoinSerialize();
        ...
        // Extend the b24 chain to make sure motacoind isn't accepting b24
        ...
        // Extend the b26 chain to make sure motacoind isn't accepting b26
        ...
        // Extend the b28 chain to make sure motacoind isn't accepting b28
        ...
        Block b56;
        try {
            b56 = new Block(params, b57.motacoinSerialize());
        ...
        Block b64;
        {
            ...
            for (Transaction transaction : b64Created.getTransactions())
                transaction.motacoinSerialize(stream);
            ...
            checkState(Arrays.equals(stream.toByteArray(), b64.motacoinSerialize()));
        ...
        Block b71 = new Block(params, b72.motacoinSerialize());
