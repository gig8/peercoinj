...
import com.gig8.motacoinj.core.AddressMessage;
import com.gig8.motacoinj.core.Block;
import com.gig8.motacoinj.core.HeadersMessage;
import com.gig8.motacoinj.core.PeerAddress;
import com.gig8.motacoinj.core.MotaCoinSerializer;
import com.gig8.motacoinj.core.Transaction;
...
public class MotaCoinSerializerTest {
    ...
    public void testAddr() throws Exception {
        MotaCoinSerializer bs = new MotaCoinSerializer(MainNetParams.get());
    ...
    public void testLazyParsing()  throws Exception {
        MotaCoinSerializer bs = new MotaCoinSerializer(MainNetParams.get(), true, false);
    ...
    private void testCachedParsing(boolean lazy)  throws Exception {
        MotaCoinSerializer bs = new MotaCoinSerializer(MainNetParams.get(), lazy, true);
    ...
    @Test
    public void testMotaCoinPacketHeader() {
        try {
            new MotaCoinSerializer.MotaCoinPacketHeader(ByteBuffer.wrap(new byte[]{0}));
            fail();
        ...
        try {
            new MotaCoinSerializer.MotaCoinPacketHeader(ByteBuffer.wrap(wrongMessageLength));
            fail();
    ...
    public void testSeekPastMagicBytes() {
        ...
        try {
            new MotaCoinSerializer(MainNetParams.get()).seekPastMagicBytes(ByteBuffer.wrap(brokenMessage));
            fail();
        } catch (BufferUnderflowException e) {
            // expected
        }
