...
public class CoinTest {
    ...
    public void testToFriendlyString() {
        assertEquals("1.00 MOTA", COIN.toFriendlyString());
        assertEquals("1.23 MOTA", valueOf(1, 23).toFriendlyString());
        assertEquals("0.001 MOTA", COIN.divide(1000).toFriendlyString());
        assertEquals("-1.23 MOTA", valueOf(1, 23).negate().toFriendlyString());
    }

    /**
     * Test the motacoinValueToPlainString amount formatter
     */
    @Test
