...
import static com.gig8.motacoinj.core.Coin.CENT;
import static com.gig8.motacoinj.core.Coin.COIN;
import static com.gig8.motacoinj.core.Coin.SATOSHI;
import static com.gig8.motacoinj.core.Coin.ZERO;
...
public class MonetaryFormatTest {
    ...
    private static final MonetaryFormat NO_CODE = MonetaryFormat.MOTA.noCode();
    ...
    public void standardCodes() throws Exception {
        assertEquals("MOTA 0.00", MonetaryFormat.MOTA.format(Coin.ZERO).toString());
        assertEquals("mMOTA 0.00", MonetaryFormat.MMOTA.format(Coin.ZERO).toString());
        assertEquals("µMOTA 0", MonetaryFormat.UMOTA.format(Coin.ZERO).toString());
    }

    @Test
    public void customCode() throws Exception {
        assertEquals("dMOTA 0", MonetaryFormat.UMOTA.code(1, "dMOTA").shift(1).format(Coin.ZERO).toString());
    }

    @Test
    public void codeOrientation() throws Exception {
        assertEquals("MOTA 0.00", MonetaryFormat.MOTA.prefixCode().format(Coin.ZERO).toString());
        assertEquals("0.00 MOTA", MonetaryFormat.MOTA.postfixCode().format(Coin.ZERO).toString());
    }

    @Test
    public void codeSeparator() throws Exception {
        assertEquals("MOTA@0.00", MonetaryFormat.MOTA.codeSeparator('@').format(Coin.ZERO).toString());
    }

    @Test(expected = NumberFormatException.class)
    public void missingCode() throws Exception {
        MonetaryFormat.UMOTA.shift(1).format(Coin.ZERO);
    }
    ...
    public void parse() throws Exception {
        ...
        assertEquals(Coin.MILLICOIN, MonetaryFormat.MMOTA.parse("1"));
        assertEquals(Coin.MILLICOIN, MonetaryFormat.MMOTA.parse("1.0"));
        assertEquals(Coin.MILLICOIN, MonetaryFormat.MMOTA.parse("01.0000000000"));
        assertEquals(Coin.MILLICOIN, MonetaryFormat.MMOTA.positiveSign('+').parse("+1.0"));
        assertEquals(Coin.MILLICOIN.negate(), MonetaryFormat.MMOTA.parse("-1"));
        assertEquals(Coin.MILLICOIN.negate(), MonetaryFormat.MMOTA.parse("-1.0"));

        assertEquals(Coin.MICROCOIN, MonetaryFormat.UMOTA.parse("1"));
        assertEquals(Coin.MICROCOIN, MonetaryFormat.UMOTA.parse("1.0"));
        assertEquals(Coin.MICROCOIN, MonetaryFormat.UMOTA.parse("01.0000000000"));
        assertEquals(Coin.MICROCOIN, MonetaryFormat.UMOTA.positiveSign('+').parse("+1.0"));
        assertEquals(Coin.MICROCOIN.negate(), MonetaryFormat.UMOTA.parse("-1"));
        assertEquals(Coin.MICROCOIN.negate(), MonetaryFormat.UMOTA.parse("-1.0"));
