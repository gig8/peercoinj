...
package com.gig8.motacoinj.utils;

import com.gig8.motacoinj.core.Coin;
...
import static com.gig8.motacoinj.core.NetworkParameters.MAX_MONEY;
import static com.gig8.motacoinj.utils.PpcAutoFormat.Style.CODE;
import static com.gig8.motacoinj.utils.PpcAutoFormat.Style.SYMBOL;
import static com.gig8.motacoinj.utils.PpcFixedFormat.REPEATING_DOUBLETS;
import static com.gig8.motacoinj.utils.PpcFixedFormat.REPEATING_TRIPLETS;
...
public class PpcFormatTest {
    ...
    public void parseTest() throws java.text.ParseException {
        ...
        assertEquals(valueOf(2022224200000L), us.parseObject("Ꝑ2,022,224.20"));
        assertEquals(valueOf(2022224200000L), us.parseObject("MOTA2,022,224.20"));
        assertEquals(valueOf(2022224200000L), us.parseObject("MOTA2,022,224.20"));
        ...
        // MilliCoins
        assertEquals(valueOf(2000), usCoded.parseObject("mMOTA 2"));
        assertEquals(valueOf(2000), usCoded.parseObject("mMOTA 2"));
        assertEquals(valueOf(2000), usCoded.parseObject("mꝐ 2"));
        assertEquals(valueOf(2000), usCoded.parseObject("mꝐ 2"));
        assertEquals(valueOf(2000), us.parseObject("mMOTA2"));
        assertEquals(valueOf(2000), us.parseObject("mMOTA2"));
        assertEquals(valueOf(2000), us.parseObject("₥Ꝑ2"));
        assertEquals(valueOf(2000), us.parseObject("₥Ꝑ2"));
        assertEquals(valueOf(2000), us.parseObject("₥2"));
        assertEquals(valueOf(2000), usCoded.parseObject("₥MOTA 2.00"));
        assertEquals(valueOf(2000), usCoded.parseObject("₥MOTA 2.00"));
        assertEquals(valueOf(2000), usCoded.parseObject("₥MOTA 2"));
        assertEquals(valueOf(2000), usCoded.parseObject("₥MOTA 2"));
        ...
        assertEquals(valueOf(2022224000L), us.parseObject("₥MOTA2,022,224"));
        assertEquals(valueOf(2022224000L), us.parseObject("₥MOTA2,022,224"));
        assertEquals(valueOf(2022224000L), us.parseObject("mMOTA2,022,224"));
        assertEquals(valueOf(2022224000L), us.parseObject("mMOTA2,022,224"));
        ...
        assertEquals(valueOf(2022224000L), usCoded.parseObject("₥MOTA 2,022,224"));
        assertEquals(valueOf(2022224000L), usCoded.parseObject("₥MOTA 2,022,224"));
        assertEquals(valueOf(2022224000L), usCoded.parseObject("mMOTA 2,022,224"));
        assertEquals(valueOf(2022224000L), usCoded.parseObject("mMOTA 2,022,224"));
        ...
        assertEquals(valueOf(4), us.parseObject("uꝐ4"));
        assertEquals(valueOf(4), us.parseObject("µꝐ4"));
        assertEquals(valueOf(4), us.parseObject("uMOTA4"));
        assertEquals(valueOf(4), us.parseObject("uMOTA4"));
        assertEquals(valueOf(4), us.parseObject("µMOTA4"));
        assertEquals(valueOf(4), us.parseObject("µMOTA4"));
        assertEquals(valueOf(4), usCoded.parseObject("uMOTA 4"));
        assertEquals(valueOf(4), usCoded.parseObject("uMOTA 4"));
        assertEquals(valueOf(4), usCoded.parseObject("µMOTA 4"));
        assertEquals(valueOf(4), usCoded.parseObject("µMOTA 4"));
        // fractional satoshi; round up
        assertEquals(valueOf(5), us.parseObject("uMOTA4.5"));
        assertEquals(valueOf(5), us.parseObject("uMOTA4.5"));
        // negative with mu symbol
        assertEquals(valueOf(-1), usCoded.parseObject("(µꝐ 1)"));
        assertEquals(valueOf(-10), us.parseObject("(µMOTA10)"));
        assertEquals(valueOf(-10), us.parseObject("(µMOTA10)"));
    ...
    public void parseMetricTest() throws ParseException {
        ...
        // coin
        assertEquals(parseCoin("1"), cp.parseObject("MOTA 1.00"));
        assertEquals(parseCoin("1"), sp.parseObject("MOTA1.00"));
        ...
        assertEquals(parseCoin("1"), sp.parseObject("Ꝑ1.00"));
        // milli
        assertEquals(parseCoin("0.001"), cp.parseObject("mMOTA 1.00"));
        assertEquals(parseCoin("0.001"), sp.parseObject("mMOTA1.00"));
        ...
        assertEquals(parseCoin("0.001"), cp.parseObject("mꝐ 1.00"));
        assertEquals(parseCoin("0.001"), sp.parseObject("mꝐ1.00"));
        assertEquals(parseCoin("0.001"), cp.parseObject("₥MOTA 1.00"));
        assertEquals(parseCoin("0.001"), sp.parseObject("₥MOTA1.00"));
        ...
        assertEquals(parseCoin("0.001"), sp.parseObject("₥Ꝑ1.00"));
        // micro
        assertEquals(parseCoin("0.000001"), cp.parseObject("uMOTA 1.00"));
        assertEquals(parseCoin("0.000001"), sp.parseObject("uMOTA1.00"));
        ...
        assertEquals(parseCoin("0.000001"), cp.parseObject("uꝐ 1.00"));
        assertEquals(parseCoin("0.000001"), sp.parseObject("uꝐ1.00"));
        assertEquals(parseCoin("0.000001"), cp.parseObject("µMOTA 1.00"));
        assertEquals(parseCoin("0.000001"), sp.parseObject("µMOTA1.00"));
        ...
        assertEquals(parseCoin("0.000001"), sp.parseObject("µꝐ1.00"));
        // satoshi
        assertEquals(parseCoin("0.000001"), cp.parseObject("uMOTA 1"));
        assertEquals(parseCoin("0.000001"), sp.parseObject("uMOTA1"));
        ...
        assertEquals(parseCoin("0.000001"), cp.parseObject("uꝐ 1"));
        assertEquals(parseCoin("0.000001"), sp.parseObject("uꝐ1"));
        assertEquals(parseCoin("0.000001"), cp.parseObject("µMOTA 1"));
        assertEquals(parseCoin("0.000001"), sp.parseObject("µMOTA1"));
        ...
        assertEquals(parseCoin("0.000001"), sp.parseObject("µꝐ1"));
        // cents
        assertEquals(parseCoin("0.012345"), cp.parseObject("cMOTA 1.2345"));
        assertEquals(parseCoin("0.012345"), sp.parseObject("cMOTA1.2345"));
        ...
        assertEquals(parseCoin("0.012345"), cp.parseObject("cꝐ 1.2345"));
        assertEquals(parseCoin("0.012345"), sp.parseObject("cꝐ1.2345"));
        assertEquals(parseCoin("0.012345"), cp.parseObject("¢MOTA 1.2345"));
        assertEquals(parseCoin("0.012345"), sp.parseObject("¢MOTA1.2345"));
        ...
        assertEquals(parseCoin("0.012345"), sp.parseObject("¢Ꝑ1.2345"));
        // dekacoins
        assertEquals(parseCoin("12.34567"), cp.parseObject("daMOTA 1.234567"));
        assertEquals(parseCoin("12.34567"), sp.parseObject("daMOTA1.234567"));
        ...
        assertEquals(parseCoin("12.34567"), sp.parseObject("daꝐ1.234567"));
        // hectocoins
        assertEquals(parseCoin("123.4567"), cp.parseObject("hMOTA 1.234567"));
        assertEquals(parseCoin("123.4567"), sp.parseObject("hMOTA1.234567"));
        ...
        assertEquals(parseCoin("123.4567"), sp.parseObject("hꝐ1.234567"));
        // kilocoins
        assertEquals(parseCoin("1234.567"), cp.parseObject("kMOTA 1.234567"));
        assertEquals(parseCoin("1234.567"), sp.parseObject("kMOTA1.234567"));
        ...
        assertEquals(parseCoin("1234.567"), sp.parseObject("kꝐ1.234567"));
        // megacoins
        assertEquals(parseCoin("1234567"), cp.parseObject("MMOTA 1.234567"));
        assertEquals(parseCoin("1234567"), sp.parseObject("MMOTA1.234567"));
    ...
    public void currencyCodeTest() {
        ...
        PpcFormat usCoded = PpcFormat.getCodeInstance(Locale.US);
        assertEquals("µMOTA 1", usCoded.format(1));
        assertEquals("MOTA 1.00", usCoded.format(COIN));

        /* Do not insert unneeded space BEFORE currency-code */
        PpcFormat frCoded = PpcFormat.getCodeInstance(Locale.FRANCE);
        assertEquals("1 µMOTA", frCoded.format(1));
        assertEquals("1,00 MOTA", frCoded.format(COIN));
        ...
        assertEquals("µMOTA 1", deCoded.format(1));
        assertEquals("MOTA 1,00", deCoded.format(COIN));
    }
    ...
    public void autoDecimalTest() {
        ...
        assertEquals("MOTA 1", codedZero.format(COIN));
        assertEquals("µꝐ999,999", symbolZero.format(COIN.subtract(SATOSHI)));
        assertEquals("µMOTA 999,999", codedZero.format(COIN.subtract(SATOSHI)));
        assertEquals("µꝐ999,950", symbolZero.format(COIN.subtract(Coin.valueOf(50))));
        assertEquals("µMOTA 999,950", codedZero.format(COIN.subtract(Coin.valueOf(50))));
        assertEquals("µꝐ999,949", symbolZero.format(COIN.subtract(Coin.valueOf(51))));
        assertEquals("µMOTA 999,949", codedZero.format(COIN.subtract(Coin.valueOf(51))));
        assertEquals("Ꝑ1,000", symbolZero.format(COIN.multiply(1000)));
        assertEquals("MOTA 1,000", codedZero.format(COIN.multiply(1000)));
        assertEquals("µꝐ100", symbolZero.format(Coin.valueOf(100)));
        assertEquals("µMOTA 100", codedZero.format(Coin.valueOf(100)));
        assertEquals("µꝐ50", symbolZero.format(Coin.valueOf(50)));
        assertEquals("µMOTA 50", codedZero.format(Coin.valueOf(50)));
        assertEquals("µꝐ49", symbolZero.format(Coin.valueOf(49)));
        assertEquals("µMOTA 49", codedZero.format(Coin.valueOf(49)));
        assertEquals("µꝐ1", symbolZero.format(Coin.valueOf(1)));
        assertEquals("µMOTA 1", codedZero.format(Coin.valueOf(1)));
        assertEquals("µꝐ49,999,999", symbolZero.format(Coin.valueOf(49999999)));
        assertEquals("µMOTA 49,999,999", codedZero.format(Coin.valueOf(49999999)));

        assertEquals("µꝐ499,500", symbolZero.format(Coin.valueOf(499500)));
        assertEquals("µMOTA 499,500", codedZero.format(Coin.valueOf(499500)));
        assertEquals("µꝐ499,499", symbolZero.format(Coin.valueOf(499499)));
        assertEquals("µMOTA 499,499", codedZero.format(Coin.valueOf(499499)));
        assertEquals("µꝐ500,490", symbolZero.format(Coin.valueOf(500490)));
        assertEquals("µMOTA 500,490", codedZero.format(Coin.valueOf(500490)));
        ...
        assertEquals("MOTA 1.00", codedTwo.format(COIN));
        assertEquals("µꝐ999,999", symbolTwo.format(COIN.subtract(SATOSHI)));
        assertEquals("µMOTA 999,999", codedTwo.format(COIN.subtract(SATOSHI)));
        assertEquals("Ꝑ1,000.00", symbolTwo.format(COIN.multiply(1000)));
        assertEquals("MOTA 1,000.00", codedTwo.format(COIN.multiply(1000)));
        assertEquals("₥Ꝑ0.10", symbolTwo.format(Coin.valueOf(100)));
        assertEquals("mMOTA 0.10", codedTwo.format(Coin.valueOf(100)));
        assertEquals("₥Ꝑ0.05", symbolTwo.format(Coin.valueOf(50)));
        assertEquals("mMOTA 0.05", codedTwo.format(Coin.valueOf(50)));
        assertEquals("µꝐ49", symbolTwo.format(Coin.valueOf(49)));
        assertEquals("µMOTA 49", codedTwo.format(Coin.valueOf(49)));
        assertEquals("µꝐ1", symbolTwo.format(Coin.valueOf(1)));
        assertEquals("µMOTA 1", codedTwo.format(Coin.valueOf(1)));
        ...
        assertEquals("MOTA 1.000", codedThree.format(COIN));
        assertEquals("₥Ꝑ999.999", symbolThree.format(COIN.subtract(SATOSHI)));
        assertEquals("mMOTA 999.999", codedThree.format(COIN.subtract(SATOSHI)));
        assertEquals("Ꝑ1,000.000", symbolThree.format(COIN.multiply(1000)));
        assertEquals("MOTA 1,000.000", codedThree.format(COIN.multiply(1000)));
        assertEquals("₥Ꝑ0.100", symbolThree.format(Coin.valueOf(100)));
        assertEquals("mMOTA 0.100", codedThree.format(Coin.valueOf(100)));
        assertEquals("₥Ꝑ0.050", symbolThree.format(Coin.valueOf(50)));
        assertEquals("mMOTA 0.050", codedThree.format(Coin.valueOf(50)));
        assertEquals("₥Ꝑ0.049", symbolThree.format(Coin.valueOf(49)));
        assertEquals("mMOTA 0.049", codedThree.format(Coin.valueOf(49)));
        assertEquals("₥Ꝑ0.001", symbolThree.format(Coin.valueOf(1)));
        assertEquals("mMOTA 0.001", codedThree.format(Coin.valueOf(1)));
    }
    ...
    @Test
    public void motaRounding() throws Exception {
        PpcFormat coinFormat = PpcFormat.getCoinInstance(Locale.US);
    ...
    public void negativeTest() throws Exception {
        assertEquals("-1,00 MOTA", PpcFormat.getInstance(FRANCE).format(COIN.multiply(-1)));
        assertEquals("MOTA -1,00", PpcFormat.getInstance(ITALY).format(COIN.multiply(-1)));
        assertEquals("Ꝑ -1,00", PpcFormat.getSymbolInstance(ITALY).format(COIN.multiply(-1)));
        assertEquals("MOTA -1.00", PpcFormat.getInstance(JAPAN).format(COIN.multiply(-1)));
        assertEquals("Ꝑ-1.00", PpcFormat.getSymbolInstance(JAPAN).format(COIN.multiply(-1)));
        assertEquals("(MOTA 1.00)", PpcFormat.getInstance(US).format(COIN.multiply(-1)));
        assertEquals("(Ꝑ1.00)", PpcFormat.getSymbolInstance(US).format(COIN.multiply(-1)));
        // assertEquals("MOTA -१.००", PpcFormat.getInstance(Locale.forLanguageTag("hi-IN")).format(COIN.multiply(-1)));
        assertEquals("MOTA -๑.๐๐", PpcFormat.getInstance(new Locale("th","TH","TH")).format(COIN.multiply(-1)));
    ...
    public void equalityTest() throws Exception {
        ...
        // all the same (after setting the currency symbols to motacoins)
    ...
    public void attributeTest() throws Exception {
        ...
        assertTrue(codePat.contains("MOTA") && ! codePat.contains("(^|[^Ꝑ])Ꝑ([^Ꝑ]|$)") && ! codePat.contains("(^|[^¤])¤([^¤]|$)"));
        String symPat = PpcFormat.getSymbolInstance(Locale.US).pattern();
        assertTrue(symPat.contains("Ꝑ") && !symPat.contains("MOTA") && !symPat.contains("¤¤"));

        assertEquals("MOTA #,##0.00;(MOTA #,##0.00)", PpcFormat.getCodeInstance(Locale.US).pattern());
    ...
    public void toStringTest() {
        ...
        assertEquals("Auto-format MOTA #,##0.00;(MOTA #,##0.00)", PpcFormat.getCodeInstance(Locale.US).toString());
        assertEquals("Auto-format MOTA #,##0.0000;(MOTA #,##0.0000)", PpcFormat.getCodeInstance(Locale.US, 4).toString());
        ...
        assertEquals("Auto-format MOTA#,00Ꝑ;MOTA-#,00Ꝑ",
                     PpcFormat.builder().style(SYMBOL).locale(GERMANY).pattern("¤¤#¤").build().toString());
        assertEquals("Coin-format MOTA#,00Ꝑ;MOTA-#,00Ꝑ",
                     PpcFormat.builder().scale(0).locale(GERMANY).pattern("¤¤#¤").build().toString());
        assertEquals("Millicoin-format MOTA#.00Ꝑ;MOTA-#.00Ꝑ",
    ...
    public void patternDecimalPlaces() {
        ...
        assertEquals("Millicoin-format MOTA #.000;MOTA -#.000", f.toString());
        assertEquals("mMOTA 1000.000", f.format(COIN));
    }
    ...
    public void builderTest() {
        ...
        assertEquals("MOTA -1,00", built.format(COIN.multiply(-1)));
        built = PpcFormat.builder().pattern("¤¤##,###.#").scale(3).locale(US).build();
        assertEquals("mMOTA1,000.00", built.format(COIN));
        built = PpcFormat.builder().pattern("¤ ##,###.#").scale(3).locale(US).build();
        ...
        built = PpcFormat.builder().style(CODE).code("MOTA").locale(US).build();
        assertEquals("MOTA 1.00", built.format(COIN));
        ...
        built = PpcFormat.builder().style(CODE).code("MOTA").locale(US).build();
        assertEquals("mMOTA 1.00", built.format(COIN.divide(1000)));

        built = PpcFormat.builder().style(SYMBOL).symbol("\uA750").locale(US).build();
        assertEquals("₥Ꝑ0.10", built.format(valueOf(100)));
        built = PpcFormat.builder().style(CODE).code("MOTA").locale(US).build();
        assertEquals("mMOTA 0.10", built.format(valueOf(100)));
