// This file shows how to use motacoinj from Javascript.
// To run, grab the motacoinj bundled JAR and then do something like this:
//
//   jjs -cp motacoinj-0.12-bundled.jar demo.js
//
...
//
//   jjs -cp motacoinj-0.12-bundled.jar
//
...
//
//   jjs -cp motacoinj-0.12-bundled.jar:$slf4fj demo.js
//
...
// Nashorn, unlike V8, is thread safe (because it runs on the JVM). And motacoinj is a threaded library. This means you
