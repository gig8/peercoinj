...
# Change this to point to where you have a copy of the motacoinj.jar
sys.path.append(r"/path/to/motacoinj-0.12-SNAPSHOT-bundled.jar")
...
if __name__ == "__main__":
    params = com.google.motacoin.params.TestNet3Params.get()
